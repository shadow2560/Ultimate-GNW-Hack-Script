...
pacman -S mingw-w64-x86_64-python mingw-w64-x86_64-python-pip mingw-w64-x86_64-python-lz4 mingw-w64-x86_64-python-pillow mingw-w64-x86_64-python-tqdm mingw-w64-x86_64-python-yaml mingw-w64-x86_64-python-pyzopfli mingw-w64-x86_64-python-pyelftools mingw-w64-x86_64-python-pycryptodome mingw-w64-x86_64-python-keystone mingw-w64-x86_64-python-colorama mingw-w64-x86_64-python-numpy mingw-w64-x86_64-python-psutil --noconfirm --needed
