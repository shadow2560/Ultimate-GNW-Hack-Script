...
if [ ! -z "$run" ]; then
	...
	if [ $4 -ge 3 ]; then
		if [ $size -eq 4 ]; then #triple boot 4MB
			echo make -j$6 GNW_TARGET=$2 INTFLASH_ADDRESS=0x08020000 EXTFLASH_SIZE=1622016 EXTFLASH_OFFSET=2572288  ADAPTER=$1 BIG_BANK=0 STATE_SAVING=$7 CODEPAGE=$8 UICODEPAGE=$8 COVERFLOW=$9 ENABLE_SCREENSHOT=${10} CHEAT_CODES=${11} SHARED_HIBERNATE_SAVESTATE=${12} DISABLE_SPLASH_SCREEN=${13} FORCE_NOFRENDO=${14} flash
			make -j$6 GNW_TARGET=$2 INTFLASH_ADDRESS=0x08020000 EXTFLASH_SIZE=1622016 EXTFLASH_OFFSET=2572288  ADAPTER=$1 BIG_BANK=0 STATE_SAVING=$7 CODEPAGE=$8 UICODEPAGE=$8 COVERFLOW=$9 ENABLE_SCREENSHOT=${10} CHEAT_CODES=${11} SHARED_HIBERNATE_SAVESTATE=${12} DISABLE_SPLASH_SCREEN=${13} FORCE_NOFRENDO=${14} flash
		else 
			((size=size-6))
			echo make -j$6 GNW_TARGET=$2 INTFLASH_ADDRESS=0x08020000 EXTFLASH_SIZE_MB=$size EXTFLASH_OFFSET=6291456  ADAPTER=$1 BIG_BANK=0 STATE_SAVING=$7 CODEPAGE=$8 UICODEPAGE=$8 COVERFLOW=$9 ENABLE_SCREENSHOT=${10} CHEAT_CODES=${11} SHARED_HIBERNATE_SAVESTATE=${12} DISABLE_SPLASH_SCREEN=${13} FORCE_NOFRENDO=${14} flash
			make -j$6 GNW_TARGET=$2 INTFLASH_ADDRESS=0x08020000 EXTFLASH_SIZE_MB=$size EXTFLASH_OFFSET=6291456  ADAPTER=$1 BIG_BANK=0 STATE_SAVING=$7 CODEPAGE=$8 UICODEPAGE=$8 COVERFLOW=$9 ENABLE_SCREENSHOT=${10} CHEAT_CODES=${11} SHARED_HIBERNATE_SAVESTATE=${12} DISABLE_SPLASH_SCREEN=${13} FORCE_NOFRENDO=${14} flash
		fi
	elif [ $4 -eq 1 ]; then
